...
const CACHE = 'pain-tracker-v42';
const FIREBASE_VERSION = '12.18.0';
const SHELL = ['.', 'index.html', 'styles.css?v=42', 'app.js?v=42', 'data.js?v=42',
  'sync-data.js?v=42', 'sync.js?v=42', 'firebase-config.js?v=42', 'manifest.webmanifest', 'icon.svg'];
const OPTIONAL = [
