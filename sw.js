...
const CACHE = 'pain-tracker-v64';
const FIREBASE_VERSION = '12.18.0';
const SHELL = ['.', 'index.html', 'styles.css?v=64', 'app.js?v=64', 'data.js?v=64',
  'sync-data.js?v=64', 'sync.js?v=64', 'firebase-config.js?v=64', 'manifest.webmanifest', 'icon.svg'];
const OPTIONAL = [
